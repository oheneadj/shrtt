  ...
  return (
          ...
          {shortUrl}{" "}
            ...
            <div className="flex flex-row items-center justify-between">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-trash hover:text-red-500 text-gray-500 mr-3 mt-3" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
