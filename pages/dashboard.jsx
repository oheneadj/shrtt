...
const Dashboard = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    //  setTimeout(setError("hidden"), 5000);
  ...
  return (
    <>
      ...
      <div className="bg-blue-100 h-full">
        <div className="flex flex-col items-center justify-center">
<div className={error}>
<div className="flex items-center bg-red-500 text-white text-sm font-bold px-4 py-3 mt-10 ease-in-out duration-300 " role="alert">
                ...
                <div className="relative flex">
                  ...
                  <div className="absolute right-0 my-2 mr-3 cursor-pointer">
                    ...
                    >
                      ...
                      role="button"
                      className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-500 border rounded hover:bg-indigo-500 px-4 py-3 w-full"
                    disabled>
                      Creating Short Link
                    </button>}
                  </div>
